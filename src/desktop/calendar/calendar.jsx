    ...
    <>
      {isModal ? (
        <div className="w-full h-full fixed top-0 left-0 bg-black/40 z-50 flex flex-col justify-center items-center">
          <div className="w-[700px] h-[600px] rounded-2xl bg-white py-5 px-10 flex flex-col items-center">
            <XMarkIcon
              className="text-orange size-8 self-end"
              onClick={() => setIsModal(false)}
            />
            <form className="px-5 py-5 w-[500px] h-full flex flex-col items-center justify-between">
              ...
              <div className="flex w-full justify-between items-center">
                <span>함께하는 멤버</span>
                <select
                  className="border-2 border-yellow w-[200px]"
                  name=""
                  id=""
                >
                  <option value="">asdf</option>
